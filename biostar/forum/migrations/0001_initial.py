# Generated by Django 2.0.1 on 2018-06-04 11:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.IntegerField(choices=[(2, 'No Messages'), (3, 'Default'), (0, 'Local Messages'), (1, 'Email Message'), (4, 'Mailing List ( email for every new thread )')], default=0)),
