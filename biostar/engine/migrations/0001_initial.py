# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-12-21 00:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('help', models.CharField(default='description', max_length=1024)),
                ('uid', models.CharField(max_length=32, unique=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='datatype',
            name='project',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='engine.Project'),
        ),
        migrations.AddField(
            model_name='data',
            name='project',
