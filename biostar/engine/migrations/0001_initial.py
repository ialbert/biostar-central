    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access', models.IntegerField(choices=[(1, 'No Access'), (2, 'Read Access'), (3, 'Recipe Access'), (4, 'Execute Access')], default=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.IntegerField(choices=[(1, 'Queued'), (2, 'Running'), (7, 'Paused'), (6, 'Spooled'), (3, 'Completed'), (4, 'Error'), (5, 'Deleted'), (8, 'Restored')], default=1)),
                ('name', models.CharField(default='name', max_length=256)),
