# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-11-27 01:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access', models.IntegerField(choices=[(1, 'Public'), (2, 'Read'), (3, 'Recipe'), (4, 'Execute'), (7, 'Upload'), (5, 'Edit'), (6, 'Admin')], default=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='no name', max_length=256)),
                ('summary', models.TextField(blank=True, default='no summary', max_length=10000)),
                ('image', models.ImageField(blank=True, default=None, max_length=1024, upload_to=biostar.engine.models.image_path)),
                ('sticky', models.BooleanField(default=False)),
                ('text', models.TextField(blank=True, default='no description', max_length=10000)),
                ('html', models.TextField(default='html')),
                ('date', models.DateTimeField(auto_now_add=True)),
