...
# biostar.engine.migrations.0003_summary
...
class Migration(migrations.Migration):
    ...
    #replaces = [('engine', '0001_initial'), ('engine', '0002_bigint'), ('engine', '0003_summary'), ('engine', '0004_lastedit'), ('engine', '0005_ranks_sticky')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(default='Project summary.', max_length=10000)),
                ('deleted', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('access', models.IntegerField(choices=[(1, 'No Access'), (2, 'Read Access'), (3, 'Write Access'), (4, 'Owner Access')], db_index=True, default=2)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='engine.Project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(blank=True, default='Data summary.', max_length=10000)),
                ('image', models.ImageField(blank=True, default=None, max_length=1024, upload_to=biostar.engine.models.image_path)),
                ('sticky', models.BooleanField(default=False)),
                ('deleted', models.BooleanField(default=False)),
