...
urlpatterns = [
    ...
    url(r'^action/subscribe/(?P<uid>[-\w]+)/(?P<redir_view>[-\w]+)/$', views.discussion_subs, name='discussion_subs'),
    ...
    url(r'^discussion/vote/(?P<uid>[-\w]+)/(?P<redir_view>[-\w]+)/$', views.discussion_vote, name='discussion_vote'),
