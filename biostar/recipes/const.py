...
FILES_BOARD = "files"
LINKED_RECIPES = "linked"

# All destined to be pasted as data
DATA_SPECIFIC_BOARD = ','.join([DATA_BOARD, RESULTS_BOARD, FILES_BOARD])

RECIPE_SPECIFIC_BOARD = ','.join([RECIPE_BOARD, LINKED_RECIPES])
