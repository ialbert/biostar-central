...
def get_user(cursor, user_id):
    """
    Use information from source database to query users from target database.
    """
...
def get_project(cursor, project_id):
    """
    Use information from source database to query projects from target database.
    """
...
def get_recipe(cursor, recipe_id):
    """
    Use information from source database to query recipes from target database.
    """
